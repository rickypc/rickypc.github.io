...
import darsanaMukta from '#buddhism/practical-daily-practice/phrases/_darsana_mukta';
import mahamani from '#buddhism/practical-daily-practice/phrases/_mahamani_vipulavimana';

jest.mock('#buddhism/practical-daily-practice/phrases/_darsana_mukta', () => ({
  default: {

...
describe('timeline.Content', () => {
  ...
  it('renders wrapper and timeline items with correct layout when single = false', () => {
    ...
    // eslint-disable-next-line testing-library/no-container,testing-library/no-node-access
    const wrappers = container.querySelectorAll<HTMLElement>('.timeline');
    ...
    wrappers.forEach((w, idx) => {
      ...
      const h3 = headings.find((h) => h.tagName === 'H3') as HTMLElement;
      // Title link.
      ...
      const h4 = headings.find((h) => h.tagName === 'H4') as HTMLElement;

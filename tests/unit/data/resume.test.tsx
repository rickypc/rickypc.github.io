...
describe('data.resume.certifications', () => {
...
describe('data.resume.educations', () => {
  test('has a heading with correct structure', () => {
...
describe('data.resume.experiences', () => {
  test('has a heading with correct structure', () => {
...
describe('data.resume.leadership', () => {
  test('has a heading with correct structure', () => {
...
describe('data.resume.strengths', () => {
  test('has a heading with correct structure', () => {
...
describe('data.resume.testimonials', () => {
  test('has a heading with correct structure', () => {
...
describe('data.resume.timelineMap', () => {
  test('creates a map keyed by prefix', () => {

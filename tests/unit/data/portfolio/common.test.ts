...
describe('portfolio.common', () => {
  ...
  test('matches the exact exported object shape and value equality', () => {
    expect(transition).toEqual({ damping: 25, stiffness: 120, type: 'spring' });
  });

  test('spreading the object does not add extra enumerable properties', () => {

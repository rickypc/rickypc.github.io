  ...
  return {
    definition: {
      content: [
        ...
        { style: 'prayer', text: 'ༀ་བཛྲ་ཨཱ་ཡུ་ཥེ་སྭཱ་ཧཱ།' },
        { style, text },
        { style: 'bija', text: 'སྭཱ' },
        { style: 'prayer', text: 'ཡེདྷརྨཱཧེཏུཔྲབྷབཱཿ ཧེཏུནྟེཥཱནྟཐཱགཏེཧྱབདཏ། ཏེཥཱཉྩཡོནིརོདྷ། ཨེཝཾབཱདཱིམཧཱཤྲམཎཿསྭཱཧཱ།' },
        { style: 'bija', text: 'ཧཱ།' },
        { style: 'prayer', text: 'སུ་པྲ་ཏིཥྛ་བཛྲ་ཡེ་སྭཱ་ཧཱ།' },
      ],
      defaultStyle: {
        alignment: 'center',
        color: '#cc0000',
      ...
      info: {
        ...
        subject: 'Placing prayer on the back of paubha/thangka will purify defilement and obscuration, increase wisdom, and attain Buddhahood in this lifetime',
        title: `${transliteration?.title} paubha/thangka prayer`,
      },
      pageMargins: [0, 0, 0, 0],

...
const config: Config = {
  ...
  */
  ...
  themeConfig: {
    ...
    metadata: [
      { content: 'Ricky Huang', name: 'author' },
      { content: 'https://ricky.one/img/self.png', property: 'og:image' },
      {
        content: 'Ricky Huang: Engineering Leadership & Full Stack Innovation',
        property: 'og:site_name',
      },
      { content: 'website', property: 'og:type' },
      { content: 'summary', name: 'twitter:card' },
      { content: 'https://ricky.one/img/self.png', name: 'twitter:image' },
      { content: '@rickypc2000', name: 'twitter:site' },
    ],
    navbar: {
      items: [
        // Left.

...
describe('docs.buddhism.media._common.instruction()', () => {
...
describe('docs.buddhism.media._common.header()', () => {
...
describe('docs.buddhism.media._common.main()', () => {
...
describe('docs.buddhism.media._common.phrase()', () => {
...
describe('docs.buddhism.media._common.phrases()', () => {
...
describe('docs.buddhism.media._common.properCase', () => {
  test.each([

...
import amoghapasaPadmaUsnisa from '#buddhism/practical-daily-practice/phrases/_amoghapasa_padma_usnisa';
import puja from '#buddhism/practical-daily-practice/phrases/_amoghapasa_mani_puja';

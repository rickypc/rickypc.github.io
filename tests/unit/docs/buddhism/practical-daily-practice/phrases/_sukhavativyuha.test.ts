...
import amitabha from '#buddhism/practical-daily-practice/phrases/_amitabha';
import sukhavativyuha from '#buddhism/practical-daily-practice/phrases/_sukhavativyuha';

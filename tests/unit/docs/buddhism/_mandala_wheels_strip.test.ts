...
import mandalaWheelsStrip from '#buddhism/_mandala_wheels_strip';
...
describe('docs.buddhism._mandala_wheels_strip', () => {
  it('builds the mandala wheels strip document correctly', async () => {

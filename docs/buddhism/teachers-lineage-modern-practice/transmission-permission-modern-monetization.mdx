...
description: A clear explanation of traditional Buddhist transmissions - lung, wang, and tri - and how modern monetization, permissions, and retreat culture can create confusion for practitioners.
keywords: [
  'lung',
  'wang',
  'tri',

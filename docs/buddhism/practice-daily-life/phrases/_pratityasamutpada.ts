...
const core = {
  ...
  pali: {
    ...
    sinhala: {
      children: ['යේ ධර්මා හේතුප්‍රභවා හේතුං තේෂාං තථාගත උවාච', 'තේෂාංච යෝ නිරෝධ ඒවංවාදී මහාශ්‍රමණඃ'].join(' . '),
    },
  },
  sanskrit: {
    children: ['ये धर्मा हेतुप्रभवा हेतुं तेषां तथागत उवाच', 'तेषांच यो निरोध एवंवादी महाश्रमणः'].join(' । '),
    siddham: {
      children: ['𑖧𑖸 𑖠𑖨𑖿𑖦𑖯 𑖮𑖸𑖝𑖲𑖢𑖿𑖨𑖥𑖪𑖯 𑖮𑖸𑖝𑖲𑖽 𑖝𑖸𑖬𑖯𑖽 𑖝𑖞𑖯𑖐𑖝 𑖄𑖪𑖯𑖓', '𑖝𑖸𑖬𑖯𑖽𑖓 𑖧𑖺 𑖡𑖰𑖨𑖺𑖠 𑖊𑖪𑖽𑖪𑖯𑖟𑖱 𑖦𑖮𑖯𑖫𑖿𑖨𑖦𑖜𑖾'].join(' 𑗂 '),
    },
  },
  tibetan: {
    children: ['ཡེ་དྷ་རྨཱ་ཧེ་ཏུ་པྲ་བྷ་བཱ་ཧེ་ཏུཾ་ཏེ་ཥཱཾ་ཏ་ཐཱ་ག་ཏ་ཨུ་བཱ་ཙ', 'ཏེ་ཥཱཾ་ཙ་ཡོ་ནི་རོ་དྷ་ཨེ་བཾ་བཱ་དཱི་མ་ཧཱ་ཤྲ་མ་ཎཿ'].join(
      '། ',
    ),
  },
  transliteration: {

...
describe('data.timeline.faqItems', () => {
...
describe('data.timeline.schema', () => {
  test('is ProfilePage for timeline', () => {
    expect(schema).toBe('ProfilePage');
  });
});

describe('data.timeline.timelineMap', () => {
...
describe('data.timeline.timelines', () => {

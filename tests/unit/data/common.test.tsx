...
describe('data.common.faqContext()', () => {
...
describe('data.common.faqEntries()', () => {
...
describe('data.common.humanizeYears()', () => {
  test.each([
    // Decades format.
...
describe('data.common.numberToWords()', () => {
  test.each([
    // Zero.
    [0, 'zero'],
...
describe('data.common.textContent()', () => {

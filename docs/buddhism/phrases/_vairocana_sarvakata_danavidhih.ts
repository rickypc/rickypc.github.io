...
export default {
  ...
  transliteration: {
    ...
    repetition: 3,
    speech: 'oum suks-mei suks-mei sa-mei samaye, san-t dan-t samarope, analambe tarambe, yaso-wati maha teje, nirakula nirwane, sarwa buddhadhisthanadhisthite swaha',
